    ...
    <a href="{{ route('events.index') }}" class="btn btn-outline-primary btn-lg" style="margin: 20px;">Back to Events</a>
        ...
        <form action="{{ route('events.update', $event->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="time" name="start_time" class="form-control" id="start_time" value="{{ $event->start_time }}" required>
            </div>
            <div class="form-group">
                <label for="end_time">End Time</label>
                <input type="time" name="end_time" class="form-control" id="end_time" value="{{ $event->end_time }}" required>
            </div>
            <div class="form-group">

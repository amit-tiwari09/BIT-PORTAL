    ...
    <style>
        ...
        @media (max-width: 600px) {
            .lightbox-content {
                ...
                max-height: 90%;
                /* Allow for more height on smaller screens */
            }
            ...
            .lightbox-content img {
                max-height: 60vh;
                /* Allow more height for images on smaller screens */
            }
        ...
        @media (max-width: 400px) {
            ...
            .lightbox-content {
                width: 95%;
                /* Further increase width on very small screens */
            }

            .lightbox-content img {
                max-height: 70vh;
                /* Allow even more height for images on very small screens */
            }
